...
export const products = [
  ...
  { id: 61, category: 'fans',     image: '/cat_fans.png', name: 'Havells Epic BLDC 1200mm',          brand: 'Havells',  price: 3299,  originalPrice: 3999,  tag: 'Bestseller',
    desc: 'Havells Epic 1200mm BLDC ceiling fan. 35W, 100% copper motor, remote & regulator compatible. EcoActive technology.' },
  { id: 62, category: 'fans',     image: '/cat_fans.png', name: 'Havells Epic Signia BLDC 1200mm',    brand: 'Havells',  price: 4999,  originalPrice: 5999,  tag: 'Smart Display',
    desc: 'Havells Epic Signia with interactive LED speed/mode display, RF remote. Sleep, Breeze & Boost modes. 5-star BEE.' },
  { id: 63, category: 'fans',     image: '/cat_fans.png', name: 'Havells Stealth Air BLDC 1200mm',    brand: 'Havells',  price: 5499,  originalPrice: 6499,  tag: 'Silent',
    desc: 'Havells Stealth Air — aerodynamic blades for near-silent operation. Premium finish, RF remote. 5-star rated.' },
  { id: 64, category: 'fans',     image: '/cat_fans.png', name: 'Havells Fab Pro BLDC 1200mm',        brand: 'Havells',  price: 2999,  originalPrice: 3699,  tag: 'Value',
    desc: 'Havells Fab Pro entry-level BLDC fan. 38W, remote control, 5-star rated. Ideal for bedrooms & living rooms.' },
  { id: 65, category: 'fans',     image: '/cat_fans.png', name: 'Havells Inveno LX BLDC 1200mm',      brand: 'Havells',  price: 6499,  originalPrice: 7999,  tag: 'Premium',
    desc: 'Havells Inveno LX premium ABS blades for ultra-silent, high-airflow performance. Smart RF remote, 5-star.' },
  { id: 66, category: 'fans',     image: '/cat_fans.png', name: 'Havells Neoma Underlight BLDC 1200mm',brand: 'Havells', price: 8999,  originalPrice: 10999, tag: 'Underlight',
    desc: 'Havells Neoma BLDC with integrated LED underlight. App + voice control, Sleep/Boost modes. 5-star premium.' },
  { id: 67, category: 'fans',     image: '/cat_fans.png', name: 'Havells Sprint Table Fan 400mm',     brand: 'Havells',  price: 1450,  originalPrice: 1800,  tag: 'Table Fan',
  ...
  { id: 68, category: 'fans',     image: '/cat_fans.png', name: 'Atomberg Efficio Alpha 1200mm BLDC', brand: 'Atomberg', price: 2799,  originalPrice: 3499,  tag: 'Popular',
    desc: 'Atomberg Efficio Alpha — standard BLDC, remote control, 28W. Saves up to 65% energy. 5-year warranty.' },
  { id: 69, category: 'fans',     image: '/cat_fans.png', name: 'Atomberg Renesa Prime 1200mm BLDC',  brand: 'Atomberg', price: 3999,  originalPrice: 4799,  tag: 'Smart',
    desc: 'Atomberg Renesa Prime with RF remote, LED speed indicator, timer & sleep mode. 28W BLDC. 5-star rated.' },
  { id: 70, category: 'fans',     image: '/cat_fans.png', name: 'Atomberg Studio Nexus Smart 1200mm', brand: 'Atomberg', price: 5499,  originalPrice: 6499,  tag: 'IoT Smart',
    desc: 'Atomberg Studio Nexus — IoT-enabled, app & voice control (Alexa/Google). Boost, Sleep, Breeze modes. 5-star.' },
  { id: 89, category: 'fans',     image: '/cat_fans.png', name: 'Atomberg Aris Contour 1200mm BLDC',  brand: 'Atomberg', price: 6999,  originalPrice: 8499,  tag: 'Designer',
    desc: 'Atomberg Aris Contour — premium design, high airflow, smart features. 30W BLDC. App & voice control.' },
  { id: 90, category: 'fans',     image: '/cat_fans.png', name: 'Atomberg Renesa+ 900mm BLDC',        brand: 'Atomberg', price: 3499,  originalPrice: 4199,  tag: 'Compact',
    desc: 'Atomberg Renesa+ 900mm compact BLDC fan for smaller rooms. Remote, timer, LED indicator. 25W.' },
  { id: 91, category: 'fans',     image: '/cat_fans.png', name: 'Orient Electric Apex-FX 1200mm',     brand: 'Orient Electric', price: 2400, originalPrice: 2900, tag: 'Durable',
    desc: 'Orient Apex-FX 1200mm with double ball bearing motor. 3-speed pull-chain.' },
  { id: 92, category: 'fans',     image: '/cat_fans.png', name: 'Orient Electric Aeroquiet 1200mm',   brand: 'Orient Electric', price: 2950, originalPrice: 3600, tag: 'Silent',
    desc: 'Orient Aeroquiet — ultra-silent at 36 dB. 3-year warranty, anti-dust coating.' },
  { id: 93, category: 'fans',     image: '/cat_fans.png', name: 'Crompton Aura Prime 1200mm',         brand: 'Crompton', price: 2200, originalPrice: 2700, tag: 'Reliable',
